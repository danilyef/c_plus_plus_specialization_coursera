...
std::string Color::ToString() const {
    ...
    if (std::holds_alternative<Rgb>(color_)) {
        ...
        ss << "rgb(" << static_cast<int>(rgb.red) << "," << static_cast<int>(rgb.green) << "," << static_cast<int>(rgb.blue) << ")";
        return ss.str();
        ...
        ss << "rgba(" << static_cast<int>(rgba.red) << "," << static_cast<int>(rgba.green) << "," << static_cast<int>(rgba.blue) << "," << rgba.alpha << ")";
        return ss.str();
    }
    return "none";
}
