...
void TestDatabase() 
{
	...
	// Last
	{
		...
		db.Add(d1, "e1");
		db.Add(d2, "e2");
		AssertEqual(db.Last(d), ((Date(2018, 12, 22).to_string()) + " e2"), "db Last 1");
		Date const d3(2018, 12, 24);
		db.Add(d3, "e3");
		AssertEqual(db.Last(d), ((Date(2018, 12, 24).to_string()) + " e3"), "db Last 2");
		...
		AssertEqual(db.Last(d), ((Date(2018, 12, 22).to_string()) + " e2"), "db Last 4");
		AssertEqual(db.Last(d1), ((Date(2019, 1, 2).to_string()) + " e1"), "Db Last 5");
		db.Add(d2, "e4");
		AssertEqual(db.Last(d2), ((Date(2018, 12, 22).to_string()) + " e4"), "db Last 6");
	}
